...
# 配置信息
ws_connect_config = {
    "base_url": os.getenv("DOUBAO_WS_URL", "wss://openspeech.bytedance.com/api/v3/realtime/dialogue"),
    "headers": {
        "X-Api-App-ID": os.getenv("DOUBAO_APP_ID", "8278104837"),
        "X-Api-Access-Key": os.getenv("DOUBAO_ACCESS_KEY", "uVDs_1pFKyvnDIrFy149yYhkCkbJ4yRZ"),
        "X-Api-Resource-Id": os.getenv("DOUBAO_RESOURCE_ID", "volc.speech.dialog"),  # 固定值
        "X-Api-App-Key": os.getenv("DOUBAO_APP_KEY", "PlgvMymc7f3tQnJ6"),  # 固定值
...
start_session_req = {
    ...
    "tts": {
        "speaker": os.getenv("DOUBAO_TTS_SPEAKER", "zh_male_taocheng_uranus_bigtts"),
